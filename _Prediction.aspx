<%@ Page Title="" Language="C#" MasterPageFile="~/Farmer/FarmerMaster.Master" AutoEventWireup="true" CodeBehind="_Prediction.aspx.cs" Inherits="patternPrediction.Farmer._Prediction" %>
          ...
          <tr>
              ...
              <td>
                  ...
                  <asp:Button ID="btnSubmit" runat="server" onclick="btnSubmit_Click" 
                      Text="Predict Disease" ValidationGroup="pwd" Height="50px" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </span>
                  <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                      Text="Refresh" Height="50px" />
              </td>
              <td>
                  &nbsp;</td>
          </tr>
