...
namespace patternPrediction.Farmer
{
    public partial class PostQueries : System.Web.UI.Page
    {
        ...
        public void GetFarmerQueries()
        {
            tab.Rows.Clear();
            tab = obj.GetQueriesByFarmerId(Session["FarmerId"].ToString());
            ...
            else
            {
                ...
                cell.Text = "No Farmer Queries Found!!!";
        ...
        {
            tab.Rows.Clear();
            tab = obj.GetNewQueriesByFarmerId(Session["FarmerId"].ToString());
        ...
        {
            tab.Rows.Clear();
            tab = obj.GetOldQueriesByFarmerId(Session["FarmerId"].ToString());
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                obj.InsertNewQuery(Session["FarmerId"].ToString(), txt_postQuestion.Text, DateTime.Now);
